...
void Renderer::Render(Snake const snake, SDL_Point const &food, SDL_Point const &extraFood, bool const &hasExtraFood) {
  SDL_Rect block;
  ...
  if (hasExtraFood)
  {
    SDL_SetRenderDrawColor(sdl_renderer, 0xAA, 0xBB, 0xCC, 0xEE);
